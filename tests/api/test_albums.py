...
# POST Test by Name - PASS - New record
@mark.order(7)
@mark.parametrize("tablename, version, name", 
...
# POST Test by Name - PASS - UNIQUE contraint
@mark.order(9)
@mark.parametrize("tablename, version, name", 
    [param("albums", "v1", "name", id="Albums")])
...
# PUT Album Test by Id - PASS - AlbumTitle
@mark.order(13)
@mark.parametrize("tablename, version, record", 
...
# PUT Album Test by Id - PASS - ArtistId
@mark.order(14)
@mark.parametrize("tablename, version, record", 
    [param("albums", "v1", 348, id="Albums")])
...
# PUT Album Test by Id - FAIL - Unknown Id
@mark.order(15)
@mark.parametrize("tablename, version, record", 
    [param("albums", "v1", 999, id="Albums")])
...
# PUT Album Test by Id - FAIL - Unknown ArtistId
@mark.order(16)
@mark.parametrize("tablename, version, record", 
    [param("albums", "v1", 348, id="Albums")])
...
# PUT Album Test by Name - PASS - AlbumTitle
@mark.order(17)
@mark.parametrize("tablename, version, name", 
...
# PUT Album Test by Name - PASS - ArtistId
@mark.order(18)
@mark.parametrize("tablename, version, name", 
    [param("albums", "v1", "Test Album", id="Albums")])
...
# PUT Album Test by Name - FAIL - Unknown ArtistId
@mark.order(19)
@mark.parametrize("tablename, version, name", 
    [param("albums", "v1", "Test Album", id="Albums")])
...
# DELETE Album Test by Id - FAIL - Unknown Id
@mark.order(21)
@mark.parametrize("tablename, version, record", 
    [param("albums", "v1", 348, id="Albums")])
...
# DELETE Album Test by Name - PASS
@mark.order(22)
@mark.parametrize("tablename, version, name", 
    [param("albums", "v1", "Test Album", id="Albums")])
...
# DELETE Album Test by Name - FAIL - Not Found
@mark.order(23)
@mark.parametrize("tablename, version, name", 
    [param("albums", "v1", "Test Album", id="Albums")])
